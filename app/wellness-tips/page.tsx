    ...
    <main className="min-h-screen bg-main-bg">
      {isMobile ? (
        ...
        <>
          ...
          <div className="bg-black overflow-hidden px-4 py-24">
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row items-stretch">
                {/* Left Film Roll */}
                <div className="w-full lg:w-[20%] h-[400px] lg:h-auto mb-8 lg:mb-0">
                ...
                {/* Center Text Content */}
                <div className="w-full lg:w-[60%] space-y-4 text-center relative px-16">
                  {/* Vertical Lines with higher z-index */}
                  <div className="absolute -left-8 top-1/2 -translate-y-1/2 w-1 h-32 bg-[#e3f677]/30 hidden lg:block z-20" />
                  <div className="absolute -right-8 top-1/2 -translate-y-1/2 w-1 h-32 bg-[#e3f677]/30 hidden lg:block z-20" />

                  {/* Text content with adjusted sizing */}
                  <motion.h1
                    className="text-[8vw] sm:text-[10vw] lg:text-[6vw] font-black text-white leading-none tracking-tighter"
                  ...
                  <motion.div
                    className="bg-[#e3f677] px-8 py-2 mx-4 w-full"
                    initial={{ opacity: 0, scale: 0.9 }}
                    whileInView={{ opacity: 1, scale: 1 }}
                    transition={{ duration: 0.5, delay: 0.2 }}
                  >
                    <h1 className="text-[8vw] sm:text-[10vw] lg:text-[5.5vw] font-black text-black leading-none tracking-tighter whitespace-nowrap overflow-visible w-full">
                      WELLNESS
                    </h1>
                  </motion.div>
                  <motion.h1
                ...
                {/* Right Film Roll */}
                <div className="w-full lg:w-[20%] h-[400px] lg:h-auto mt-8 lg:mt-0">
          ...
          <RotatingBanner />
          <ThreePhoneShowcase />
          <section className="py-24 px-4 sm:px-8 bg-white" id="health-tips">
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row justify-between items-start mb-16">
                <h2 className="text-[4rem] md:text-[5.5rem] font-light leading-none mb-8 lg:mb-0">Health Tips</h2>
                  ...
                  <div key={index} className="block">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={handleNavClick(`/wellness-tips/${tip.slug}`)}
                          className="text-sm text-black hover:text-gray-600 transition-colors flex items-center"
                        >
                          Learn More <ArrowRight className="ml-1 h-4 w-4" />
                        </button>
                      </div>
                      <button onClick={handleNavClick(`/wellness-tips/${tip.slug}`)} className="block text-left">
                        <h3 className="text-4xl font-light hover:text-gray-800 transition-colors">{tip.title}</h3>
          ...
          <section className="py-24 px-4 sm:px-8 bg-white">
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div>
                  <h2 className="text-[3.5rem] md:text-[4.5rem] font-light leading-none mb-8">
                    Daily Dose of
                    <br />
                    Wellness
                  </h2>
          ...
          <section className="py-24 px-4 sm:px-8 bg-white" id="patient-education">
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-col lg:flex-row justify-between items-start mb-16">
                <h2 className="text-[4rem] md:text-[5.5rem] font-light leading-none mb-8 lg:mb-0">Patient Education</h2>
                <p className="text-sm max-w-[400px] tracking-wide text-gray-600">
                    ...
                    <div className="bg-white rounded-2xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl h-full flex flex-col">
                      ...
                      <div className="p-6 flex flex-col flex-grow">
                        ...
                        <Button
                          ...
                          onClick={handleNavClick(`/wellness-tips/${item.slug}`)}
                        >
                          Learn More
...
function MobileWellnessTipsPageContent() {
  const router = useRouter()
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-stretch">
            ...
            <div className="w-full space-y-4 text-center relative px-4">
              ...
              <motion.div
                className="bg-[#e3f677] px-4 py-2 mx-4 w-full"
                initial={{ opacity: 0, scale: 0.9 }}
                whileInView={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.5, delay: 0.2 }}
              >
      ...
      <section className="py-24 px-4 bg-white" id="health-tips">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col justify-between items-start mb-16">
            <h2 className="text-3xl font-light leading-none mb-8">Health Tips</h2>
              ...
              <div key={index} className="block">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2">
                    <p className="text-sm tracking-wide text-gray-600">{tip.category} |</p>
                    <Link
                      href={`/wellness-tips/${tip.slug}`}
                      className="text-sm text-black hover:underline flex items-center"
                    >
                      Learn More <ArrowRight className="ml-1 h-4 w-4" />
                    </Link>
                  </div>
                  <Link href={`/wellness-tips/${tip.slug}`} className="block text-left">
                    <h3 className="text-2xl font-light hover:text-gray-800 transition-colors">{tip.title}</h3>
                    <p className="text-gray-600 mt-2">{tip.description}</p>
                  </Link>
                </div>
              </div>
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-light leading-none mb-8">
                Daily Dose of
                <br />
                Wellness
              </h2>
      ...
      <section className="py-24 px-4 bg-white" id="patient-education">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col justify-between items-start mb-16">
            <h2 className="text-3xl font-light leading-none mb-8">Patient Education</h2>
            <p className="text-sm max-w-full tracking-wide text-gray-600">
              EMPOWER YOURSELF WITH KNOWLEDGE ABOUT CHIROPRACTIC CARE AND YOUR HEALTH.
            </p>
          </div>
