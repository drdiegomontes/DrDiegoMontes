    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden pt-16 pb-8 px-4">
        <div className="w-full max-w-[95vw] mx-auto">
          <div className="relative h-[50vh] min-h-[300px] rounded-[2.5rem] overflow-hidden">
            <Image
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white px-4">
              <h1 className="text-3xl sm:text-4xl font-light mb-4 text-center max-w-5xl">
                Connect with Dr. Diego Montes
              </h1>
              <p className="text-base sm:text-lg mb-6 text-center max-w-2xl">
                Take the first step towards a healthier, pain-free life. Reach out to us today and experience the power
            ...
            <div>
              ...
              <div className="mt-6 space-y-6">
                <p className="text-lg text-gray-600">
                  Don't let pain hold you back any longer. Dr. Diego Montes and his team are ready to help you achieve
                  optimal health and wellness through personalized chiropractic care.
                </p>
                <Button className="bg-black text-white hover:bg-black/90">Start Your Journey Today</Button>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 bg-white px-4">
        <div className="max-w-7xl mx-auto">
          <div className="bg-white rounded-3xl p-8 shadow-xl relative overflow-hidden">
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#7FFFD4] opacity-10 rounded-full -mt-16 -mr-16"></div>
            <div className="absolute bottom-0 left-0 w-32 h-32 bg-[#7FFFD4] opacity-10 rounded-full -mb-16 -ml-16"></div>
            <div className="relative z-10 text-center">
              <h3 className="text-3xl font-light mb-4">Ready to Take the Next Step?</h3>
              <p className="text-lg text-gray-600 mb-6">Schedule your appointment or send us an inquiry below.</p>
              <Button
                id="get-started-btn"
                className="bg-black text-white hover:bg-gray-800 text-base px-6 py-2 rounded-full transition-all duration-300 transform hover:scale-105"
              >
                <a href="#contact-forms">Get Started</a>
              </Button>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-xl mb-16">
            <div className="grid grid-cols-1 gap-16">
              <div className="space-y-8">
                <div>
                  <h2 className="text-3xl font-light mb-4">Request an Appointment</h2>
                ...
                {appointmentSuccess && (
                  ...
                  >
                    ...
                    <p className="block sm:inline">
                      Your submission has been received. Dr. Diego Montes' office will review your request and get back
                      to you soon.
                    </p>
                  </div>
                )}
              ...
              <div className="relative">
                ...
                <div className="pl-8 space-y-8">
                  <div>
                    <h2 className="text-3xl font-light mb-4">General Inquiry</h2>
      ...
      <section className="py-24 bg-gradient-to-b from-white via-gray-100 to-gray-300">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl md:text-4xl font-light mb-6 text-gray-900">Ready for Your Transformation?</h2>
